...
class ElderlyDiscountCalculator
  ...
  def discount
    ...
    if @age >= 65 and @single and @income < ELDERLY_DISCOUNT_MAXIMUM_INCOME
      ELDERLY_DISCOUNT_SINGLE
    elsif @age >= 65 and @single and @income == ELDERLY_DISCOUNT_MAXIMUM_INCOME
      ELDERLY_DISCOUNT_SINGLE
    elsif @age >= 65 and not @single and @income < ELDERLY_DISCOUNT_MAXIMUM_INCOME
      ELDERLY_DISCOUNT
    elsif @age >= 65 and not @single and @income == ELDERLY_DISCOUNT_MAXIMUM_INCOME
      ELDERLY_DISCOUNT
    else
